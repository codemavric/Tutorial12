...
namespace DUTRTV.Controllers
{
    public class PresentersController : Controller
    {
        private Tutorial12Entities db = new Tutorial12Entities();
        ...
        public ActionResult Create([Bind(Include = "PresenterId,Name,MinimumWage,TaxDeduction")] Presenter presenter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PresenterId,Name,MinimumWage,TaxDeduction")] Presenter presenter)
        {
            if (ModelState.IsValid)
            {
